...
describe('staking::setController', () => {
    it('should work', () => {
        const unsigned = setController_1.setController(test_helpers_1.TEST_METHOD_ARGS.staking.setController, txwrapper_core_1.TEST_BASE_TX_INFO, txwrapper_core_1.POLKADOT_25_TEST_OPTIONS);
