...
describe('proxy::rejectAnnouncement', () => {
    it('should work', () => {
        const unsigned = rejectAnnouncement_1.rejectAnnouncement(test_helpers_1.TEST_METHOD_ARGS.proxy.rejectAnnouncement, txwrapper_core_1.TEST_BASE_TX_INFO, txwrapper_core_1.POLKADOT_25_TEST_OPTIONS);
