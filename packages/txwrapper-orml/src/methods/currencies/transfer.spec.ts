...
describe('currencies::transfer', () => {
	it('should work', () => {
		...
		expect(unsigned.method).toBe(
			'0x0700ff8eaf04151687736326c9fea17e25fc5287613693c912909cb226aa4794f26a48000030'
		);
	});
	...
	it('should accept big numbers as string', () => {
		...
		expect(unsigned.method).toBe(
			'0x0700ff8eaf04151687736326c9fea17e25fc5287613693c912909cb226aa4794f26a4800000f04000000000020'
		);
	});
});
