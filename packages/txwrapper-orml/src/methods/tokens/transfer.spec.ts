...
describe('tokens::transfer', () => {
	it('should work', () => {
		...
		expect(unsigned.method).toBe(
			'0x15008eaf04151687736326c9fea17e25fc5287613693c912909cb226aa4794f26a48000230'
		);
	});
	...
	it('should accept big numbers as string', () => {
		...
		expect(unsigned.method).toBe(
			'0x15008eaf04151687736326c9fea17e25fc5287613693c912909cb226aa4794f26a4800020f04000000000020'
		);
	});
});
