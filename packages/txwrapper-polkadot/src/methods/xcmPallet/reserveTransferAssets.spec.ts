...
describe('xcmPallet::reserveTransferAssets', () => {
	it('Should work for xcm V0', () => {
		...
		expect(unsigned.method).toBe(
			'0x6302000101411f0001020066168b7e94b956ce2ba83d4a0b8226c1de7a3526139f30690c08be5daa9ebe3200040a00070010a5d4e800000000'
		);
	});
	...
	it('Should work for xcm V1', () => {
		...
		expect(unsigned.method).toBe(
			'0x6302010001009520010001010054fabff72b8ec769b862e4e841837cd394b59910c8507ec6b753e7b89364cf600104000000000b00602225aa3f00000000'
		);
	});
});
