...
describe('createSigningPayloadToU8a', () => {
	...
	it('should workfor Astar', () => {
		...
		expect(u8aToHex(signingPayload)).toEqual(
			'0x1f070046ef637afac0ffa9ec7a7cf76c5e0148200a401e2a1efcf2c16ee1554b74a22030db2a080f0000c52ebca2b157000000020000009eb76c5184c4ab8679d2d5d819fdf90b9c001403e9e17da2e14b6d8aec4029c66c8453305b978e867b2ccacea94e01a4ea49dfd6eb0965b6c0ccf36b295e16b5',
		);
	});
});
